...
var tokenStore = map[uint64]map[common.Address]*Token{
	...
	27435: {
		common.HexToAddress("0x4389c41c35e48b29c02820d7fc3508c92bb135b3"): &Token{
			Address:  common.HexToAddress("0x4389c41c35e48b29c02820d7fc3508c92bb135b3"),
			Name:     "EquiX Coin",
			Symbol:   "EQUIX",
			Color:    "#f8f8f8",
			Decimals: 18,
		...
		common.HexToAddress("0x1094ad909900810cb63cfedf475d5f9092abb4e6"): &Token{
			Address:  common.HexToAddress("0x1094ad909900810cb63cfedf475d5f9092abb4e6"),
			Name:     "COP EquiX Token",
			Symbol:   "COPx",
			Color:    "#f8f8f8",
			Decimals: 18,
			ChainID:  27435,
		},
		common.HexToAddress("0x1a6752aea915224106b0fd4dc9484547461b9354"): &Token{
			Address:  common.HexToAddress("0x1a6752aea915224106b0fd4dc9484547461b9354"),
			Name:     "USD EquiX Token",
			Symbol:   "USDx",
			Color:    "#f8f8f8",
			Decimals: 18,
			ChainID:  27435,
		},
		common.HexToAddress("0x7d1d35b99d37836cc0fe720e7e0985b60e666aa8"): &Token{
			Address:  common.HexToAddress("0x7d1d35b99d37836cc0fe720e7e0985b60e666aa8"),
			Name:     "CAD EquiX Token",
			Symbol:   "CADx",
			Color:    "#f8f8f8",
			Decimals: 18,
			ChainID:  27435,
		},
		common.HexToAddress("0x67e80e9cd13230833c0b1421b3b7e90ed8531c08"): &Token{
			Address:  common.HexToAddress("0x67e80e9cd13230833c0b1421b3b7e90ed8531c08"),
			Name:     "MXN EquiX Token",
			Symbol:   "MXNx",
			Color:    "#f8f8f8",
			Decimals: 18,
			ChainID:  27435,
		},
		common.HexToAddress("0xf752e8bfb263a51a09e1514f04b07df6e29df637"): &Token{
			Address:  common.HexToAddress("0xf752e8bfb263a51a09e1514f04b07df6e29df637"),
			Name:     "CLP EquiX Token",
			Symbol:   "CLPx",
			Color:    "#f8f8f8",
			Decimals: 18,
			ChainID:  27435,
		},
		common.HexToAddress("0x047edaf3f2301798bef8c7a31564d206fb12e4ab"): &Token{
			Address:  common.HexToAddress("0x047edaf3f2301798bef8c7a31564d206fb12e4ab"),
			Name:     "ARS EquiX Token",
			Symbol:   "ARSx",
			Color:    "#f8f8f8",
			Decimals: 18,
			ChainID:  27435,
		},
		common.HexToAddress("0x294b19b3a0d53f2275d61304206ee6f968d85cd6"): &Token{
			Address:  common.HexToAddress("0x294b19b3a0d53f2275d61304206ee6f968d85cd6"),
			Name:     "BRL EquiX Token",
			Symbol:   "BRLx",
			Color:    "#f8f8f8",
			Decimals: 18,
			ChainID:  27435,
