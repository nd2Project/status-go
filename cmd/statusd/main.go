...
var (
	...
	fleet = flag.String(
		...
		fmt.Sprintf(
			...
			[]string{params.FleetProd, params.FleetStaging, params.FleetTest, params.FleetWakuV2Prod, params.FleetWakuV2Test, params.FleetStatusTest, params.FleetStatusProd, params.Fleetnd2alphaProd}, params.FleetProd,
		),
	)
